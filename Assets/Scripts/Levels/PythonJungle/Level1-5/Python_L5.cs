...
{
    public class Python_L5 : MonoBehaviour
    {
        // Public variables
...
def main():
	...
	allGrassCut = 1
	davidHappy = 1
	cutGrass = " + codeInput1.text + @"
	cutFlower = " + codeInput2.text + @"
	trees = " + codeInput3.text + @"
	cutNest = " + codeInput4.text + @"
	done = " + codeInput5.text + @"
	if(cutGrass == 1):
		correct = correct + 1
	else:
		print(""cutGrass = incorrect"")
	if(cutFlower == 1):
		correct = correct + 1
	else:
		print(""cutFlower = incorrect"")
	if(trees == 1 or trees == 0):
		correct = correct + 1
	else:
		print(""trees = incorrect"")
	if(cutNest == 1):
		correct = correct + 1
	else:
		print(""cutNest = incorrect"")
	if(done == 1):
		correct = correct + 1
	else:
	...
	return";
        ...
        private void PythonPrint(MemoryStream data)
        {
            ...
            {
                lawnmover.SetActive(true); // Sets levelSprite to trigger complete
