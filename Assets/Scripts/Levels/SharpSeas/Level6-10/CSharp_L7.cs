    ...
    public class CSharp_L7 : MonoBehaviour
    {
        ...
        private Assembly CSharpCompile(string sourceCode)
        {
            ...
            if (result.Errors.HasErrors)
            {
                ...
                {
                    if (error[0].ErrorNumber == "CS0165")
                        programOutput.text = "Looks like you did not initialize a variable before trying to use it. Try assigning a value to your variable before trying to use it.";
                    else
